...
|------|-----------------------------------------------------------------------------------------------------------|--------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------------------|--------------------|-------------|---------------------|
| US01 | Registro de usuario                                   | T01: Desarrollar página de registro        | Desarrollar la página de registro de usuario según los criterios de aceptación                                           | 3                  | Sebastian Lobato   |      Done           |
|      |                                                                                                           | T02: Validar Datos | Incluir validaciones de datos para garantizar que se ingresen correctamente                              | 2                  | Sebastian Lobato     |      Done           |                                                                                                           
| US02 | Configuración de notificaciones               | T01: Implementar configuración de notificaciones       | Cree la funcionalidad para que los usuarios puedan configurar sus notificaciones       | 4                  | Mathias Hidalgo    |      Done           |
|      |                                                                                                           | T02: Validación de configuración | Asegurarse de que las opciones seleccionadas se guardan correctamente en la base de datos             | 5                  | Astrid Boronda      |      Done           |
| US03 | Cerrar sesion                                                                           | T01: Implementar cierre se sesión              | Desarrollar la función de cierre de sesión según los criterios de aceptación        | 3                  | Mathias Hidalgo    |      Done           |
|      |                                                                                                           | T02: Mover al inicio al cerrar       | Garantizar que el cierre de sesión redirija al usuario a la página principal sin sesión iniciada.       | 2                 | Mathias Hidalgo   |      Done           |
| US04 | Recibir Notificación                                                                    | T01: Implementar Configurar para recibir notificaciones | Implementar la funcionalidad que permita a los usuarios configurar su recepción de notificaciones    | 4                  | Astrid Boronda    |      Done           |
|      |                                                                                                           | T02: Validación de configuración | Asegúrese de que se solicite y otorgue el permiso adecuado para enviar notificaciones  | 5                | Eduard Travezaño      |      In process        |
...
| US06 | Personal de seguridad viene a mi casa                                                                                      | T01: Desarrolar funcionalidad para contratar    | Implementar la funcionalidad que permita a los usuarios contratar personal de seguridad para vigilancia                                        | 3                  | Astrid Boronda    |      Done           |
...
| US07 | Comunicación con personal de seguridad                                                                   | T01: Implementar sistema de mensajeria | Implementar un sistema de mensajería que permita a los usuarios comunicarse con el personal de seguridad contratado.           | 8                  | Ely Cortez      |      Done           |
