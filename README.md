...
|ID   | User Story                                    | Work-Item / Task                              | Description                                                                 | Estimation (Hours) | Assigned To       | Status
|-----|-----------------------------------------------|-----------------------------------------------|----------------------------------------------------------------------------|--------------------|-------------------|--------|
|US01 | Registro de usuario                           | T01: Implementar lógica de autenticación en backend | Configurar y conectar el backend para la autenticación de usuarios utilizando JWT o sesiones. | 4                  | Mathias Hidalgo   | Pending|
| | Registro de usuario                           | T02: Integrar API de perfil de usuario             | Desarrollar y conectar la API que permite la visualización y actualización del perfil de usuario. | 3                  | Mathias Hidalgo   | Pending|
|US12 | Pedidos de equipos de seguridad               | T01: Implementar lógica de gestión de pedidos en backend | Desarrollar la lógica en backend para manejar los pedidos de equipos de seguridad, incluyendo creación, actualización y eliminación. | 5                  | Ely Cortez        | Pending|
| | Pedidos de equipos de seguridad               | T02: Conectar API de servicios activos           | Integrar la API que permite la visualización y gestión de los servicios activos del usuario. | 4                  | Eduard Travezaño  | Pending|
|US11 | Contratos activados en seguridad de vigilancia| T01: Desarrollar lógica de historial de compras en backend | Implementar la lógica en backend para mantener y recuperar el historial de compras del usuario. | 5                  | Astrid Boronda    | Pending|
| | Contratos activados en seguridad de vigilancia| T02: Integrar API de contratos activos           | Desarrollar e integrar la API que permite la visualización y gestión de los contratos activos del usuario. | 4                  | Astrid Boronda    | Pending|
|US09 | Búsqueda de servicios                         | T01: Implementar lógica de búsqueda en backend   | Desarrollar la lógica en backend para soportar búsquedas de servicios por palabras clave. | 4                  | Eduard Travezaño  | Pending|
| | Búsqueda de servicios                         | T02: Integrar API de resultados de búsqueda      | Conectar la API que proporciona los resultados de búsqueda al frontend para su visualización. | 3                  | Eduard Travezaño  | Pending|
